...
contact_phone bigint(100) NOT NULL,
contact_mail varchar(50) NOT NULL,
primary key(contact_id)
);

insert into contact_info(contact_address,contact_phone,contact_mail)
values("Ananthnagar,Manipal",9480615069,"prathvi@gmail.com");
